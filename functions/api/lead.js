...
function normalizeLead(body) {
  ...
  return {
    ...
    adset: str(body.adset).slice(0, 160),
    placement: str(body.placement).slice(0, 120),
    gclid: str(body.gclid).slice(0, 200),
    gbraid: str(body.gbraid).slice(0, 200),
    wbraid: str(body.wbraid).slice(0, 200),
    ip: '',
    country: '',
    captcha_score: null,
  };
...
const VEHICLE_TABLE = {
  '11713907': { year: '2017', make: 'Honda', model: 'Accord', trim: '' },
  '8696803': { year: '2020', make: 'Nissan', model: 'Frontier', trim: '' },
  '5732699': { year: '2017', make: 'Volkswagen', model: 'Passat', trim: '' },
  '7469809': { year: '2016', make: 'Acura', model: 'ILX', trim: '' },
  '9498431': { year: '2016', make: 'Cadillac', model: 'SRX', trim: '' },
  '5730951': { year: '2014', make: 'Chevrolet', model: 'Malibu', trim: '' },
};
